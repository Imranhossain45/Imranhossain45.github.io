<div class="widget block color-default">
    <h3 class="block-title"><span>Popular News</span></h3>

    <div class="post-overaly-style clearfix">
        <div class="post-thumb">
            <a href="#">
                <img class="img-fluid" src="{{ asset('frontend/img/news/lifestyle/health4.jpg') }}" alt="" />
            </a>
        </div>
        ...
        <ul class="list-post">
            <li class="clearfix">
                <div class="post-block-style post-float clearfix">
                    <div class="post-thumb">
                        <a href="#">
                            <img class="img-fluid" src="{{ asset('frontend/img/news/tech/gadget3.jpg') }}"
                                alt="" />
                        </a>
            ...
            <li class="clearfix">
                <div class="post-block-style post-float clearfix">
                    <div class="post-thumb">
                        <a href="#">
                            <img class="img-fluid" src="{{ asset('frontend/img/news/lifestyle/travel5.jpg') }}"
                                alt="" />
                        </a>
            ...
            <li class="clearfix">
                <div class="post-block-style post-float clearfix">
                    <div class="post-thumb">
                        <a href="#">
                            <img class="img-fluid" src="{{ asset('frontend/img/news/tech/robot5.jpg') }}"
                                alt="" />
                        </a>
            ...
            <li class="clearfix">
                <div class="post-block-style post-float clearfix">
                    <div class="post-thumb">
                        <a href="#">
                            <img class="img-fluid" src="{{ asset('frontend/img/news/lifestyle/food1.jpg') }}"
                                alt="" />
                        </a>
