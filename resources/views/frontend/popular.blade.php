...
<div class="carousel-box owl-wrapper">
  ...
  <div class="owl-carousel" data-num="2">
    ...
    <div class="item">
      <div class="news-post image-post2">
        <div class="post-gallery">
          <img src="{{ asset('frontend/img/news-posts/im2.jpg') }}" alt="">
          <div class="hover-box">
      ...
      <div class="news-post image-post2">
        <div class="post-gallery">
          <img src="{{ asset('frontend/img/news-posts/im1.jpg') }}" alt="">
          <div class="hover-box">
            <div class="inner-hover">
              <a class="category-post food" href="food.html">Food &amp; Healthy</a>
              <h2><a href="single-post.html">Quisque volutpat mattis eros. Nullam malesuada erat ut turpis. </a></h2>
              <ul class="post-tags">
                <li><i class="fa fa-clock-o"></i>27 may 2013</li>
                <li><a href="#"><i class="fa fa-comments-o"></i><span>23</span></a></li>
    ...
    <div class="item">
      <div class="news-post image-post2">
        <div class="post-gallery">
          <img src="{{ asset('frontend/img/news-posts/im3.jpg') }}" alt="">
          <div class="hover-box">
            <div class="inner-hover">
      ...
      <div class="news-post image-post2">
        <div class="post-gallery">
          <img src="{{ asset('frontend/img/news-posts/im4.jpg') }}" alt="">
          <div class="hover-box">
            <div class="inner-hover">
