<div class="block color-red">
  <h3 class="block-title"><span>BPL 2024</span></h3>

  <div class="row">
    <div class="col-lg-12 col-md-12">
      @foreach ($wcnews as $index => $news)
        @if ($index == 0)
            ...
            <div class="post-content single_photo_part_post_content">
              ...
              <div class="post-meta">
                <span class="post-date"><i class="fa-solid fa-calendar-days">
                  ...
                  <a href="{{ route('journalist',$news->journalist->slug) }}" style="color: white;padding-left:10px" class="auther_name_home"><i
                  ...
                  <div class="post-content">
                    ...
                    <div class="post-meta">
                      <span class="post-date"><i class="fa-solid fa-calendar-days">
                        ...
                        <a href="{{ route('journalist',$news->journalist->slug) }}" style="color: #a3a3a3;padding-left:10px" class="auther_name auther_name_home"><i
                            class="fa-solid fa-user"></i>
                          {{ $news->journalist->name }}</a></span>
                    </div>
                    <div>
