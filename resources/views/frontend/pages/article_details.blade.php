        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
          ...
          <div class="single-post block">
            ...
            <div class="post-title-area">
              ...
              <div class="post-meta">
                <span class="post-date">
                  ...
                  </i> {{ \Carbon\Carbon::parse($blog->date)->format('d M Y h:i A') }}
                  <a href="#" style="color: #a3a3a3;padding-left:10px"
                    class="auther_name">
            ...
            <div class="post-content-area">
              <div class="post-media post-featured-image">
                <a href="{{ $blog->photo }}" class="gallery-popup">
                  <img src="{{ $blog->photo }}" class="img-fluid" alt="{{ $blog->alt_text }}">
                </a>
              </div>
          ...
          {{-- <div class="author-box">
                        ...
                        <div class="author-info">
                            ...
                            <p>Selfies labore, leggings cupidatat sunt taxidermy umami fanny pack typewriter hoodie art
                                party voluptate. Listicle meditation paleo, drinking vinegar sint direct trade.</p>
          ...
          <div class="related-posts block">
            <h3 class="block-title"><span>Related Blogs</span></h3>

            <div id="related-news-slide" class="owl-carousel owl-theme related-news-slide">
              @foreach ($related_blog as $rnews)
                <div class="item">
                  <div class="post-block-style clearfix">
                    <div class="post-thumb">
                      <a href="{{ route('blog_details', $rnews->slug) }}"><img class="img-fluid"
                          src="{{ $rnews->photo }}" alt="{{ $rnews->alt_text }}" /></a>
                    </div>
                    <div class="post-content">
                      <h2 class="post-title title-medium">
                        <a href="{{ route('blog_details', $rnews->slug) }}">{{ $rnews->title }}</a>
                      </h2>
                      <div class="post-meta">
                        <span class="post-date">
                          <i class="fa-solid fa-calendar-days">
                        ...
                        <span class="post-date">
                          <a href="" style="color: #a3a3a3;padding-left:10px" class="auther_name"><i
