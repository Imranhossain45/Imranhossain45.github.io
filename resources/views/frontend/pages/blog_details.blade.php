            ...
            <div class="single-post-box">
                ...
                <div class="title-post">
                    ...
                    <ul class="post-tags">
                        ...
                        <li><i class="fa fa-user"></i>by <a href="#">{{ $blog->auther }}</a></li>
                    </ul>
                </div>
                ...
                <div class="share-post-box">
                    <ul class="share-box">
                        ...
                        <li><a class="facebook" href="#"><i class="fa fa-facebook"></i><span>Share on
                                    Facebook</span></a></li>
                        <li><a class="twitter" href="#"><i class="fa fa-twitter"></i><span>Share on Twitter</span></a>
                        </li>
                ...
                <div class="post-gallery">
                    <img src="{{ $blog->photo }}" alt="{{ $blog->alter_text }}">
                </div>
                        ...
                        <div class="tab-pane" id="more-autor">
                            <div class="more-autor-posts">
                                ...
                                <div class="news-post image-post3">
                                    <img src="{{ asset('frontend/img/news-posts/gal1.jpg') }}" alt="">
                                    <div class="hover-box">
                                ...
                                <div class="news-post image-post3">
                                    <img src="{{ asset('frontend/img/news-posts/gal2.jpg') }}" alt="">
                                    <div class="hover-box">
                                ...
                                <div class="news-post image-post3">
                                    <img src="{{ asset('frontend/img/news-posts/gal3.jpg') }}" alt="">
                                    <div class="hover-box">
                                ...
                                <div class="news-post image-post3">
                                    <img src="{{ asset('frontend/img/news-posts/gal4.jpg') }}" alt="">
                                    <div class="hover-box">
                ...
                <div class="carousel-box owl-wrapper">
                    ...
                    <div class="owl-carousel" data-num="3">
                        ...
                        <div class="item news-post image-post3">
                            <img src="{{ asset('frontend/img/news-posts/art1.jpg') }}" alt="">
                            <div class="hover-box">
                        ...
                        <div class="item news-post image-post3">
                            <img src="{{ asset('frontend/img/news-posts/art2.jpg') }}" alt="">
                            <div class="hover-box">
                        ...
                        <div class="item news-post video-post">
                            <img src="{{ asset('frontend/img/news-posts/art3.jpg') }}" alt="">
                        ...
                        <div class="item news-post image-post3">
                            <img src="{{ asset('frontend/img/news-posts/art4.jpg') }}" alt="">
                            <div class="hover-box">
                        ...
                        <div class="item news-post image-post3">
                            <img src="{{ asset('frontend/img/news-posts/art5.jpg') }}" alt="">
                            <div class="hover-box">
                                <h2><a href="single-post.html">Donec odio. Quisque volutpat mattis
                                        eros.</a></h2>
                                <ul class="post-tags">
