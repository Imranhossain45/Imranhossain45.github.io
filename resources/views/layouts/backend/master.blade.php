...
<head>
    ...
    <!-- App favicon -->
    <link rel="shortcut icon" href="{{ $generalInfo->logo }}" class="img-fluid">
                ...
                <div class="d-flex">
                    ...
                    <div class="navbar-brand-box">
                        <a href="{{ route('admin') }}" class="">
                            <span class="logo-sm">
                                <img src="{{ $generalInfo->logo }}" alt="" width="200px" class="mt-3"
                                    height="40">
                            </span>
                        </a>
                    </div>
                    ...
                    <a href="{{ route('index') }}" class="btn btn-sm px-3 font-size-20 header-item waves-effect d-flex align-items-center"
                        id="vertical-menu-btn" target="_blank">
                ...
                <div class="d-flex">
                    ...
                    <div class="dropdown d-inline-block">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            ...
                            <a href="#" id="admin_logout"
                                class="dropdown-item dash_logout text-danger ">Logout</a>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                            <div class="text-lg-end text-sm-start">
                                Design & Developed by <a href="https://www.facebook.com/mdimran.h.sagor/"
                                    target="_blank">Md Imran Hossain</a>
                            </div>
                        </div>
                    </div>
                </div>
