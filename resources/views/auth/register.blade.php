...
<section class="signup_area page_section_padding_50">
    {{-- <div class="container">
    ...
    <section class="signup_area page_section_pad_50">
        <div class="container">
        <h1 class="text-center">You Don't Have Permission To Register</h1>
    </div>
    </section>
</section>
@endsection
