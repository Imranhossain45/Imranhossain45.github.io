        ...
        <div class="col-lg-8">
          <div class="card">
            <div class="card-header">
              <h1 class="text-center">Create Video Info</h1>
            </div>
            <div class="card-body">
              <form action="{{ route('backend.videoGallery.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row mt-3">
                  ...
                  <div class="form-group col-lg-4">
                    <label>Date:</label>
                    <input type="datetime-local" name="date" class="form-control" placeholder="Enter Alter Text"
                      value="{{ old('date') }}">
                  </div>
