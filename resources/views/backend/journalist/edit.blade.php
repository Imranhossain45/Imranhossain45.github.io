        ...
        <div class="col-lg-8">
          <div class="card">
            <div class="card-header">
              <h1 class="text-center">Edit Journalist Info</h1>
            </div>
            <div class="card-body">
              <form action="{{ route('backend.journalist.update', $journalist->id) }}" method="POST"
                ...
                <div class="row mt-3">
                  ...
                  <div class=" form-group col-lg-6">
                    ...
                    <img src="{{ $journalist->photo }}" class="mt-2" alt="">
                ...
                <div class="row mt-3">
                  ...
                  <div class="form-group col-lg-3">
                    ...
                    <input type="text" name="linked_in" class="form-control" placeholder="Linkedin Link"
                      value="{{ $journalist->linked_in }}">
                  </div>
                </div>
                <div class=" form-group mt-3">
                  <label>Short Description:</label>
                  <textarea name="short_des" class="form-control " rows="7" placeholder="Enter Journalist Short Description">{{ $journalist->short_des }}</textarea>
                </div>

                <div class=" form-group mt-3">
                  <label>Description:</label>
                  <textarea name="description" id="editor" class="form-control " rows="7"
                    placeholder="Enter Journalist Description">{{ $journalist->description }}</textarea>
                </div>
